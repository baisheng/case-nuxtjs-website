...
export default class Loader extends Emitter {
  ...
  _loadData (data) {
    // console.log(data)
    gridDataManager.set('default', filter(data, (value) => !value.opensource ))
    gridDataManager.set('opensource', filter(data, (value) => value.opensource ))
    // gridDataManager.set('opensource', data)
    // gridDataManager.set('default', data)
